...
namespace Neon.Util
{
    public class VarIntBitConverterNet
    {
        /// <summary>
        ...
        public static void WriteVarintBytes(BinaryWriter writer, byte value)
        {
        ...
        /// <returns>Varint array of bytes.</returns>
        public static void WriteVarintBytes(BinaryWriter writer, short value)
        {
        ...
        /// <returns>Varint array of bytes.</returns>
        public static void WriteVarintBytes(BinaryWriter writer, ushort value)
        {
            WriteVarintBytes(writer, (ulong) value);
        }
        ...
        /// <returns>Varint array of bytes.</returns>
        public static void WriteVarintBytes(BinaryWriter writer, int value)
        {
        ...
        /// <returns>Varint array of bytes.</returns>
        public static void WriteVarintBytes(BinaryWriter writer, uint value)
        {
            WriteVarintBytes(writer, (ulong) value);
        }
        ...
        /// <returns>Varint array of bytes.</returns>
        public static void WriteVarintBytes(BinaryWriter writer, long value)
        {
        ...
        /// <returns>Varint array of bytes.</returns>
        public static void WriteVarintBytes(BinaryWriter writer, ulong value)
        {
            do
            {
        ...
        public static byte ToByte(BinaryReader reader)
        {
        ...
        public static short ToInt16(BinaryReader reader)
        {
        ...
        public static ushort ToUInt16(BinaryReader reader)
        {
        ...
        public static int ToInt32(BinaryReader reader)
        {
        ...
        public static uint ToUInt32(BinaryReader reader)
        {
        ...
        public static long ToInt64(BinaryReader reader)
        {
        ...
        public static ulong ToUInt64(BinaryReader reader)
        {
        ...
        static ulong ToTarget(BinaryReader reader, int sizeBites)
        {
            var shift = 0;
            ulong result = 0;
